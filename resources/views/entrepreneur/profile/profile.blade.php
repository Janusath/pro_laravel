              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->other }}</div>
                  </div>
                ...
                <img id="showImage"  class="rounded avatar-lg" src="{{
                    ...
                    <div class="row mb-3">
                      <label for="ownerName" class="col-md-4 col-lg-3 col-form-label">user Name</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="shopName" class="col-md-4 col-lg-3 col-form-label">other</label>
                      <div class="col-md-8 col-lg-9">
